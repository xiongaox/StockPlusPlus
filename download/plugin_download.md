...
| :--- | :--- | :---: | :--- |
| **x64 Release**（推荐） | 64 位 Windows 系统及 64 位 TrafficMonitor | [**Stock_V2.0.10_x64.zip**](./Stock_V2.0.10_x64.zip) | 推荐绝大多数用户使用，性能最优 |
| **x86 Release** | 32 位 Windows 系统或 32 位 TrafficMonitor | [**Stock_V2.0.10_x86.zip**](./Stock_V2.0.10_x86.zip) | 适用于 32 位兼容环境 |
