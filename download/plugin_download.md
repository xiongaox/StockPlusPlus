...
| :--- | :--- | :---: | :--- |
| **x64 Release**（推荐） | 64 位 Windows 系统及 64 位 TrafficMonitor | [**Stock_V2.0.8_x64.zip**](./Stock_V2.0.8_x64.zip) | 推荐绝大多数用户使用，性能最优 |
| **x86 Release** | 32 位 Windows 系统或 32 位 TrafficMonitor | [**Stock_V2.0.8_x86.zip**](./Stock_V2.0.8_x86.zip) | 适用于 32 位兼容环境 |
| **ARM64EC Release** | Windows on ARM 平台（如高通骁龙芯片、Surface Pro X） | [**Stock_V2.0.8_arm64ec.zip**](./Stock_V2.0.8_arm64ec.zip) | 专为 ARM64 设备原生优化 |
