...
#define ICON_POLYGONS(name, ...) \
	...
	// settings: gear outline approximated from arc-heavy lucide path (see
	// settings.svg), plus the inner hub circle. Arcs flattened at ~22.5° steps.
	ICON_POINTS(kSettings0, { 12.22, 2 }, { 11.78, 2 }, { 11.015, 2.152 }, { 10.366, 2.586 },
		{ 9.932, 3.235 }, { 9.78, 4 }, { 9.78, 4.18 }, { 9.659, 4.863 },
		{ 9.312, 5.464 }, { 8.78, 5.91 }, { 8.35, 6.16 }, { 7.697, 6.398 },
		{ 7.003, 6.398 }, { 6.35, 6.16 }, { 6.2, 6.08 }, { 5.462, 5.83 },
		{ 4.684, 5.88 }, { 3.985, 6.225 }, { 3.47, 6.81 }, { 3.25, 7.19 },
		{ 3, 7.928 }, { 3.05, 8.706 }, { 3.395, 9.405 }, { 3.98, 9.92 },
		{ 4.13, 10.02 }, { 4.66, 10.463 }, { 5.007, 11.06 }, { 5.13, 11.74 },
		{ 5.13, 12.25 }, { 5.011, 12.937 }, { 4.664, 13.541 }, { 4.13, 13.99 },
		{ 3.98, 14.08 }, { 3.395, 14.595 }, { 3.05, 15.294 }, { 3, 16.072 },
		{ 3.25, 16.81 }, { 3.47, 17.19 }, { 3.985, 17.775 }, { 4.684, 18.12 },
		{ 5.462, 18.17 }, { 6.2, 17.92 }, { 6.35, 17.84 }, { 7.003, 17.602 },
		{ 7.697, 17.602 }, { 8.35, 17.84 }, { 8.78, 18.09 }, { 9.312, 18.536 },
		{ 9.659, 19.137 }, { 9.78, 19.82 }, { 9.932, 20.585 }, { 10.366, 21.234 },
		{ 11.015, 21.668 }, { 11.78, 21.82 }, { 12.22, 21.82 }, { 12.985, 21.668 },
		{ 13.634, 21.234 }, { 14.068, 20.585 }, { 14.22, 19.82 }, { 14.22, 19.64 },
		{ 14.341, 18.957 }, { 14.688, 18.356 }, { 15.22, 17.91 }, { 15.65, 17.66 },
		{ 16.303, 17.422 }, { 16.997, 17.422 }, { 17.65, 17.66 }, { 17.8, 17.74 },
		{ 18.538, 17.99 }, { 19.316, 17.94 }, { 20.015, 17.595 }, { 20.53, 17.01 },
		{ 20.75, 16.62 }, { 21, 15.882 }, { 20.95, 15.104 }, { 20.605, 14.405 },
		{ 20.02, 13.89 }, { 19.87, 13.81 }, { 19.336, 13.361 }, { 18.989, 12.757 },
		{ 18.87, 12.07 }, { 18.87, 11.57 }, { 18.989, 10.883 }, { 19.336, 10.279 },
		{ 19.87, 9.83 }, { 20.02, 9.74 }, { 20.605, 9.225 }, { 20.95, 8.526 },
		{ 21, 7.748 }, { 20.75, 7.01 }, { 20.53, 6.63 }, { 20.015, 6.045 },
		{ 19.316, 5.7 }, { 18.538, 5.65 }, { 17.8, 5.9 }, { 17.65, 5.98 },
		{ 16.997, 6.218 }, { 16.303, 6.218 }, { 15.65, 5.98 }, { 15.22, 5.73 },
		{ 14.688, 5.284 }, { 14.341, 4.683 }, { 14.22, 4 }, { 14.068, 3.235 },
		{ 13.634, 2.586 }, { 12.985, 2.152 }, { 12.22, 2 });
	ICON_STROKES(kSettings, { kSettings0, _countof(kSettings0) });
	static const Circle kSettingsCircles[] = { { 12, 12, 3 } };
